...
public class TexturePortalFXSensMod extends FMLTextureFX{
    ...
    public TexturePortalFXSensMod(Block portalBlock, int[] colorShift)
    {
        super(portalBlock.blockIndexInTexture);
    ...
    public void onTick()
    {
        ...
        for (int var2 = 0; var2 < tileSizeSquare; ++var2)
        {
            ...
            this.imageData[var2 * 4 + colorShift[0]] = (byte)var3;
            this.imageData[var2 * 4 + colorShift[1]] = (byte)var4;
            this.imageData[var2 * 4 + colorShift[2]] = (byte)var5;
            this.imageData[var2 * 4 + colorShift[3]] = (byte)var6;
        }
    }
