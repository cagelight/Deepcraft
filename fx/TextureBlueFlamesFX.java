...
public class TextureBlueFlamesFX extends FMLTextureFX
{
    ...
    public TextureBlueFlamesFX(int par1)
    {
        super(SBlocks.fireBlue.blockIndexInTexture + par1 * 16);
        setup();
    }
    ...
    public void onTick()
    {
        ...
        for (var3 = 0; var3 < tileSizeSquare; ++var3)
        {
            ...
            this.imageData[var3 * 4 + 2] = (byte)var6;
            this.imageData[var3 * 4 + 0] = (byte)var7;
            this.imageData[var3 * 4 + 1] = (byte)var8;
