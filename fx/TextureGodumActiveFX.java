...
public class TextureGodumActiveFX extends FMLTextureFX{
    ...
    public TextureGodumActiveFX()
    {
        super(SBlocks.blockGodumActive.blockIndexInTexture);
        setup();
    }
        ...
        for (int var2 = 0; var2 < 32; ++var2)
        {
            for (int var3 = 0; var3 < tileSizeBase; ++var3)
            {
                for (int var4 = 0; var4 < tileSizeBase; ++var4)
                {
                    ...
                    this.portalTextureData[var2][var16 * 4 + 0] = (byte)(var13/4);
                    this.portalTextureData[var2][var16 * 4 + 1] = (byte)(var14/4);
                    this.portalTextureData[var2][var16 * 4 + 2] = (byte)(var6/4);
                    this.portalTextureData[var2][var16 * 4 + 3] = (byte)(var15/4);
                }
            }
        }
    }
