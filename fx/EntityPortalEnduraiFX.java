...
public class EntityPortalEnduraiFX extends EntityFX
{
    ...
    public EntityPortalEnduraiFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        ...
        this.particleBlue = (rand.nextFloat() * 0.4F);
