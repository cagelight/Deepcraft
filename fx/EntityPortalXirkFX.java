...
public class EntityPortalXirkFX extends EntityFX
{
	...
	public EntityPortalXirkFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
	{
		...
		this.particleGreen = (rand.nextFloat() * 0.4F) + 0.6F;
