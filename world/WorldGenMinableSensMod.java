...
public class WorldGenMinableSensMod extends WorldGenerator {
	...
	private int[] replaceBlocks = new int[] {Block.stone.blockID, Block.netherrack.blockID};

	public WorldGenMinableSensMod(int par1, int par2)
	{
		this.minableBlockId = par1;
		this.numberOfBlocks = par2;
	}

	public WorldGenMinableSensMod(int id, int meta, int number)
	{
		this(id, number);
		this.minableBlockMeta = meta;
	}
	public WorldGenMinableSensMod(int id, int number, int[] replaceBlocks)
	{
		this(id, number);
					...
					for (int var41 = var33; var41 <= var36; ++var41)
					{
						...
						if (var39 * var39 + var42 * var42 < 1.0D)
						{
							for (int var44 = var34; var44 <= var37; ++var44)
							{
								...
								if (block != null) {
									boolean blockOK=false;for(int i=0;i<replaceBlocks.length;i++){if(block.blockID==replaceBlocks[i]){blockOK=true;}}
									if (var39 * var39 + var42 * var42 + var45 * var45 < 1.0D && blockOK)
									{
