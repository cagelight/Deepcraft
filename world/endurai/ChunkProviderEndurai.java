...
public class ChunkProviderEndurai implements IChunkProvider
{
	/** RNG. */
	private Random rand;
	...
	public ChunkProviderEndurai(World par1World, long par2, boolean par4)
	{
	...
	public void populate(IChunkProvider par1IChunkProvider, int par2, int par3)
	{
		...
		if (TerrainGen.populate(par1IChunkProvider, worldObj, rand, par2, par3, var11, DUNGEON)) {
			for (var7 = 0; var7 < 2; ++var7)
			{
				...
				var13 = this.rand.nextInt(64)+32;
				var14 = var5 + this.rand.nextInt(16);
				(new EndurumCubes()).generate(this.worldObj, this.rand, var12, var13, var14);
			}
		}
