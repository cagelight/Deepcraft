...
public class ComponentNetherBridgeEnd extends ComponentNetherBridgePiece
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        for (var5 = 0; var5 <= 4; ++var5)
        {
            ...
            {
                var7 = var4.nextInt(8);
                this.fillWithBlocks(par1World, par3StructureBoundingBox, var5, var6, 0, var5, var6, var7, SBlocks.netherBrickDeep.blockID, SBlocks.netherBrickDeep.blockID, false);
            }
        }

        var5 = var4.nextInt(8);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 0, 5, 0, 0, 5, var5, SBlocks.netherBrickDeep.blockID, SBlocks.netherBrickDeep.blockID, false);
        var5 = var4.nextInt(8);
        this.fillWithBlocks(par1World, par3StructureBoundingBox, 4, 5, 0, 4, 5, var5, SBlocks.netherBrickDeep.blockID, SBlocks.netherBrickDeep.blockID, false);

        for (var5 = 0; var5 <= 4; ++var5)
        {
            var6 = var4.nextInt(5);
            this.fillWithBlocks(par1World, par3StructureBoundingBox, var5, 2, 0, var5, 2, var6, SBlocks.netherBrickDeep.blockID, SBlocks.netherBrickDeep.blockID, false);
        }
