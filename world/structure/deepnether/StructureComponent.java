...
public abstract class StructureComponent
{
    ...
    protected int getMetadataWithOffset(int par1, int par2)
    {
        ...
        {
            if (par1 != Block.stairCompactCobblestone.blockID && par1 != Block.stairCompactPlanks.blockID && par1 != SBlocks.stairsNetherBrickDeep.blockID && par1 != Block.stairsStoneBrickSmooth.blockID && par1 != Block.stairsSandStone.blockID)
            {
