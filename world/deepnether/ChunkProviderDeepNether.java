...
public class ChunkProviderDeepNether implements IChunkProvider
{
    ...
    public MapGenDeepNetherBridge genNetherBridge = new MapGenDeepNetherBridge();
    ...
    {
        genNetherBridge = (MapGenDeepNetherBridge) TerrainGen.getModdedMapGen(genNetherBridge, NETHER_BRIDGE);
        netherCaveGenerator = TerrainGen.getModdedMapGen(netherCaveGenerator, NETHER_CAVE);
    }

    public ChunkProviderDeepNether(World par1World, long par2)
    {
