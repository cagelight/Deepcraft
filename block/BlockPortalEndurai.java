...
public class BlockPortalEndurai extends BlockPortal{
	...
	public BlockPortalEndurai(int par1, int par2) {
		super(par1, par2);
	...
	public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
	{
		...
		if (par1World.getBlockId(par2 - 1, par3, par4) == SBlocks.blockEndurum.blockID || par1World.getBlockId(par2 + 1, par3, par4) == SBlocks.blockEndurum.blockID)
		{
			var5 = 1;
		}

		if (par1World.getBlockId(par2, par3, par4 - 1) == SBlocks.blockEndurum.blockID || par1World.getBlockId(par2, par3, par4 + 1) == SBlocks.blockEndurum.blockID)
		{
			var6 = 1;
		}
		...
		else
		{
			...
			for (var7 = -1; var7 <= 2; ++var7)
			{
				for (var8 = -1; var8 <= 3; ++var8)
				{
					...
					if (var7 != -1 && var7 != 2 || var8 != -1 && var8 != 3)
					{
						...
						if (var9)
						{
							if (var10 != SBlocks.blockEndurum.blockID)
							{
								return false;
							}
						}
			...
			for (var7 = 0; var7 < 2; ++var7)
			{
				...
				{
					par1World.setBlockWithNotify(par2 + var5 * var7, par3 + var8, par4 + var6 * var7, SBlocks.portalEndurai.blockID);
				}
			}
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
	{
		...
		if (par1World.getBlockId(par2, var8 - 1, par4) != SBlocks.blockEndurum.blockID)
		{
		...
		else
		{
			...
			if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == SBlocks.blockEndurum.blockID)
			{
				...
				{
					if ((par1World.getBlockId(par2 + var6, par3, par4 + var7) != SBlocks.blockEndurum.blockID || par1World.getBlockId(par2 - var6, par3, par4 - var7) != this.blockID) && (par1World.getBlockId(par2 - var6, par3, par4 - var7) != SBlocks.blockEndurum.blockID || par1World.getBlockId(par2 + var6, par3, par4 + var7) != this.blockID))
					{
						par1World.setBlockWithNotify(par2, par3, par4, 0);
					}
				}
    ...
    public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        for (int var6 = 0; var6 < 4; ++var6)
        {
            ...
            FMLClientHandler.instance().getClient().effectRenderer.addEffect((EntityFX)new EntityPortalEnduraiFX(par1World, var7, var9, var11, var13, var15, var17), null);
        }
    }
