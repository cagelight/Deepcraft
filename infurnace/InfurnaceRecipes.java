...
public class InfurnaceRecipes
{
    private static final InfurnaceRecipes smeltingBase = new InfurnaceRecipes();
     ...
     */
    public static final InfurnaceRecipes smelting()
    {
        return smeltingBase;
    }

    private InfurnaceRecipes()
    {
        ...
        this.addSmelting(SBlocks.oreValarium.blockID, new ItemStack(SItems.ingotValarium), 24.0F);
        this.addSmelting(SBlocks.oreValariumNether.blockID, new ItemStack(SItems.ingotValarium), 24.0F);
        this.addSmelting(SBlocks.oreScinite.blockID, new ItemStack(SItems.crystalScinite), 256.0F);
        this.addSmelting(SBlocks.oreSciniteNether.blockID, new ItemStack(SItems.crystalScinite), 256.0F);
        this.addSmelting(SBlocks.oreGodum.blockID, new ItemStack(SItems.crystalGodum), 1000.0F);
        this.addSmelting(SBlocks.oreGodumNether.blockID, new ItemStack(SItems.crystalGodum), 1000.0F);
        this.addSmelting(SItems.crystalGodum.itemID, new ItemStack(SItems.ingotGodum), 2500.0F);
    }
